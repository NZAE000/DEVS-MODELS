...
// Methods
    ...
    std::vector<ActiveSubtask_t*>&          getPriorityExecutions()                         noexcept;
    ...
    std::vector<ExecutionBuffer_t> const&   getExecBuffers()                          const noexcept 
...
private:
    ...
    std::vector<ActiveSubtask_t*>             priority_execs_    {};
