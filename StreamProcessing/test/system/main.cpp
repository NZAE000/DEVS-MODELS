...
/****** Switch atomic model instantiation *******************/
    ...
    sswitch = dynamic::translate::make_dynamic_atomic_model<streamprcss::Switch_t, TIME>("switch");
...
// eics, eocs, ics
    ...
    dynamic::translate::make_IC<streamprcss::Node_defs::out, streamprcss::Switch_t<TIME>::defs_port::BOOST_PP_CAT(in_, n)>(BOOST_PP_STRINGIZE(BOOST_PP_CAT(node_, n)), "switch"), \
    dynamic::translate::make_IC<streamprcss::Switch_t<TIME>::defs_port::BOOST_PP_CAT(out_, n), streamprcss::Node_defs::in>("switch", BOOST_PP_STRINGIZE(BOOST_PP_CAT(node_, n))),
    ...
    //    dynamic::translate::make_IC<streamprcs::Node_defs::out, streamprcss::Switch_t<TIME>::defs_port::in_2>("node_2", "switch"),
    //    dynamic::translate::make_IC<streamprcs::Node_defs::out, streamprcss::Switch_t<TIME>::defs_port::in_3>("node_3", "switch"),
    //    
    //    dynamic::translate::make_IC<streamprcss::Switch_t<TIME>::defs_port::out_0, streamprcs::Node_defs::in>("switch", "node_0"),
    //    dynamic::translate::make_IC<streamprcss::Switch_t<TIME>::defs_port::out_1, streamprcs::Node_defs::in>("switch", "node_1"),
    //    dynamic::translate::make_IC<streamprcss::Switch_t<TIME>::defs_port::out_2, streamprcs::Node_defs::in>("switch", "node_2"),
    //    dynamic::translate::make_IC<streamprcss::Switch_t<TIME>::defs_port::out_3, streamprcs::Node_defs::in>("switch", "node_3"),
    //};
    //dynamic::modeling::ICs ics_Cluster;
