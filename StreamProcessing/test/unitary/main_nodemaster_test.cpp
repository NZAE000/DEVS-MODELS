...
int main(void){
    ...
    //Node_t<TIME> node_s;
    //NodeMaster_t<TIME> node_m;
//
    //Node_t<TIME>& ref = node_m; // OJO
...
/****** Node master atomic model instantiations *******************/
    ...
    //Node_t<TIME>& node_m = dynamic_cast<Node_t<TIME>&>(*node_master.get());
...
// Models: data type(vector) used to define the components of a coupled model.  It contains the instances of submodels inside the coupled model.
    ...
    submodels_TOP = nodes;
    submodels_TOP.push_back(productor);
...
/*************** Loggers *******************/
    static ofstream out_messages("simulation_results/unitary/nodemaster_test_output_messages.txt");
    ...
    static ofstream out_state("simulation_results/unitary/nodemaster_test_output_state.txt");
